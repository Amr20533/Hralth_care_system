...
class AppLink{
  ...
  static const String docResetToken = '' ?? '';
  static const String userResetToken = '' ?? '';
  ...
  static const String doctorResetPassword = "/api/v1/doctors/resetPassword/$docResetToken";
  ...
  static const String userResetPassword = "/api/v1/users/resetPassword/$userResetToken";
