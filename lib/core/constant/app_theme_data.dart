...
ThemeData aTheme = ThemeData(
  ...
  textTheme: TextTheme(
    titleLarge: TextStyle(color: Colors.black,fontWeight: FontWeight.w500,fontSize: 15.h),
    titleSmall: TextStyle(color:const Color(0XFF797979),fontWeight: FontWeight.w400,fontSize: 15.h),
