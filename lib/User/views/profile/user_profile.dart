...
class UserProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: GetBuilder<ProfileControllerImp>(builder: (controller){
        ...
        return HandlingDataView(widget: SafeArea(
          child: Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                for (int i = 0; i < controller.data.length; i++)...[
                  if(controller.data[i]['id'] == controller.getUserId())...[
                    Padding(
                    ...
                    CustomTextFormAuth(
                      ...
                      hintText: "${controller.data[i]['name']}",
                      // hintText: "50".tr,
                    ...
                    CustomTextFormAuth(
                      ...
                      hintText: "${controller.data[i]['email']}",
                    ...
                    GestureDetector(
                      ...
                      child: Container(width: double.infinity,height: 40.w,
                        margin: EdgeInsets.only(top: 40.w,bottom: 5.h),
                        alignment: Alignment.center,
  ...
  int _checkUserValidity(ProfileControllerImp controller) {
    int ind = 0;
    for (int i = 0; i < controller.data.length; i++) {
      if (controller.data[i]['id'] == controller.getUserId()) {
        ind = i;
