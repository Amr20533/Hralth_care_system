...
class SpecialistCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      height: bottomSheet ? 112.0.w: 180.h,width: 300.w,
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Container(width: 80.w,height: 90.w,
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text('${phs.title}', style:Theme.of(context).textTheme.titleMedium!.copyWith(color:Colors.black,fontWeight:FontWeight.w400,fontSize: 13.w),overflow: TextOverflow.ellipsis,maxLines: 1,),
                  SizedBox(height: 3.h,),
                  Text('${phs.speciality}', style:Theme.of(context).textTheme.titleSmall!.copyWith(color:Colors.black45,fontWeight:FontWeight.w400,fontSize: 10.w),overflow: TextOverflow.ellipsis,maxLines: 1,),
                  Row(
                    children: [
                      Wrap(
                      ...
                      SizedBox(width: 3.w,),
                      Text('${phs.ratings}', style: Theme.of(context).textTheme.titleMedium!.copyWith(color:Colors.black,fontWeight:FontWeight.w500,fontSize: 12.w)),
                      ...
                      SizedBox(width: 11.w,),
                      // SizedBox(width: 16.w,),
                      Text('${phs.reviews} Reviews', style: Theme.of(context).textTheme.titleMedium!.copyWith(color:const Color(0XFF9D9D9D),fontWeight:FontWeight.w500,fontSize: 12.w)),
                    ],),
          ...
          bottomSheet ? Container() : GestureDetector(
            ...
            child: Container(width: 300.w,height: 40.w,
              ...
              child: Center(
                child: Text('Make Appointment',style: TextStyle(color: myBlueColor,fontSize: 14.w,fontWeight: FontWeight.w400),),
              ),
            ),
          )
        ],
