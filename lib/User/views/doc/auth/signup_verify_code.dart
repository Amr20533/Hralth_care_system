...
class DocSignUpVerifyCode extends StatelessWidget {
  const DocSignUpVerifyCode({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ListView(children: [
          ...
          CustomButtonAuth(text: "Check", onPressed: () {controller.goToDocSuccessSignUp();}),
